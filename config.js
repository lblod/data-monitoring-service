...
export const ANOMALY_CRITICAL_PERCENT = parseFloat(process.env.ANOMALY_CRITICAL_PERCENT || '25');
export const ANOMALY_COMPARISON_WINDOW = parseInt(process.env.ANOMALY_COMPARISON_WINDOW || '5');
export const ANOMALY_MIN_HISTORY = parseInt(process.env.ANOMALY_MIN_HISTORY || '2');
